...
function mainMenu() {
    ...
    if (selection == 'first40') {
        ...
        grades[Math.randomInt(0,11)] = 100
        ...
        document.getElementById("below50Count").innerHTML = "There is/are " + count + " grade/grades below 50"
       ...
       let increasing = 0
        ...
        for(let n = 0; n < grades.length; n++){
            increasing = Number(grades[n] * 0.1)
            grades[n]+=increasing
        ...
        for(let n = 0; n < grades.length; n++){
            decreasing = Number(grades[n] * 0.1)
            grades[n]-=decreasing
